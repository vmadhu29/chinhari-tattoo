...
<head>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($canonical)): ?>
        <link rel="canonical" href="<?php echo e($canonical); ?>">
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

    
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!OpenGraph::hasImage()): ?>
...
$value = context()->get($__contextArgs[0]); ?>": "https://schema.org",
        ...
        "telephone": "<?php echo e(config('studio.phone')); ?>",
        "email": "<?php echo e(config('studio.email')); ?>",
        "address": {
            "@type": "PostalAddress",
        ...
        "sameAs": [
            "<?php echo e(config('studio.instagram')); ?>",
            "<?php echo e(config('studio.facebook')); ?>",
            "<?php echo e(config('studio.youtube')); ?>"
        ]
    }
    </script>
...
<body class="bg-studio-black text-studio-gray min-h-screen overflow-x-hidden">
    ...
    <div id="page-loader" role="status" aria-label="Loading">
        <div class="text-center">
            <div class="loader-logo font-display text-4xl tracking-[0.3em] text-gold mb-4">CHINHARI</div>
            <div class="w-32 h-px bg-gradient-to-r from-transparent via-gold to-transparent mx-auto animate-pulse"></div>
            <p class="text-studio-muted text-xs tracking-widest uppercase mt-3">Tattoo Studio</p>
        </div>
    </div>
    ...
    >
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between">
                ...
                <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-3 group" aria-label="Chinhari Tattoo Studio">
                    <div class="relative">
                        <div class="w-10 h-10 rounded-full bg-gold/10 border border-gold/30 flex items-center justify-center group-hover:shadow-gold-sm transition-all duration-300">
                            <span class="font-display text-gold text-lg tracking-wider">C</span>
                        </div>
                    </div>
                    <div>
                        <div class="font-display text-xl tracking-[0.2em] text-studio-white group-hover:text-gold transition-colors duration-300 leading-none">CHINHARI</div>
                        <div class="text-[9px] tracking-[0.35em] text-studio-muted uppercase leading-none mt-0.5">Tattoo Studio · Raipur</div>
                    </div>
                </a>
                ...
                <nav class="hidden lg:flex items-center gap-1" aria-label="Primary">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $navItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a
                            ...
                            class="px-4 py-2 text-sm font-medium tracking-wide rounded-lg transition-all duration-200
                                   link-underline
                                   <?php echo e(request()->routeIs($item['route']) ? 'text-gold' : 'text-studio-gray hover:text-studio-white'); ?>"
                        >
                ...
                <div class="hidden lg:flex items-center gap-3">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route('customer.dashboard')); ?>" class="btn-ghost text-sm px-4 py-2">Dashboard</a>
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="btn-ghost text-sm px-4 py-2">Login</a>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                >
                    <span class="w-6 h-0.5 bg-studio-gray group-hover:bg-gold transition-all duration-300"
            ...
            >
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $navItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a
                            ...
                            class="px-4 py-3 text-sm font-medium rounded-xl transition-colors duration-200
                                   <?php echo e(request()->routeIs($item['route']) ? 'text-gold bg-gold/5' : 'text-studio-gray hover:text-white hover:bg-studio-card'); ?>"
                ...
                <div class="flex flex-col gap-3 mt-6 px-4">
                    <a href="<?php echo e(route('booking.create')); ?>" class="btn-gold w-full text-center">Book Appointment</a>
                    <a href="https://wa.me/<?php echo e(config('studio.whatsapp_number')); ?>" class="btn-whatsapp w-full text-center" target="_blank" rel="noopener">
        ...
        <div class="bg-studio-black py-16 px-4 text-center relative overflow-hidden">
            ...
            <div class="relative max-w-3xl mx-auto">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="<?php echo e(route('booking.create')); ?>" class="btn-gold btn-lg">
                        Book Free Consultation
                    </a>
                    <a href="https://wa.me/<?php echo e(config('studio.whatsapp_number')); ?>?text=Hi! I'd like to book a tattoo appointment." class="btn-outline-gold btn-lg" target="_blank" rel="noopener">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413Z"/></svg>
                        Chat on WhatsApp
                    </a>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                ...
                <div class="lg:col-span-1">
                    <div class="font-display text-3xl tracking-[0.2em] text-studio-white mb-2">CHINHARI</div>
                    <div class="text-xs tracking-[0.3em] text-gold uppercase mb-6">Tattoo Studio · Raipur</div>
                    ...
                    <div class="flex gap-3">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $socials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e($social['href']); ?>" target="_blank" rel="noopener noreferrer"
                               ...
                               class="w-10 h-10 rounded-full bg-studio-card border border-studio-border
                                ...
                                <svg class="w-4 h-4 fill-current" viewBox="0 0 24 24" aria-hidden="true"><?php echo $social['icon']; ?></svg>
                            </a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ['Realism', 'Portrait', 'Blackwork', 'Tribal', 'Geometric', 'Mandala', 'Neo Traditional', 'Cover Up']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $style): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li>
                                <a href="<?php echo e(route('portfolio', ['style' => Str::slug($style)])); ?>"
                                   class="text-sm text-studio-muted hover:text-gold transition-colors duration-200 link-underline">
                                    <?php echo e($style); ?>
                    ...
                    <address class="not-italic space-y-4">
                        <div class="flex gap-3">
                            ...
                            <div>
                                ...
                                <a href="<?php echo e(config('studio.google_maps_url')); ?>" class="text-xs text-gold hover:text-gold-light mt-1 inline-block" target="_blank" rel="noopener">Get Directions →</a>
                            </div>
                        </div>
                        ...
                        <div class="flex gap-3">
                            ...
                            <div>
                                <a href="tel:<?php echo e(config('studio.phone')); ?>" class="text-sm text-studio-muted hover:text-gold transition-colors"><?php echo e(config('studio.phone')); ?></a>
                            </div>
                        </div>
        ...
        <div class="border-t border-studio-border py-6">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
                <p class="text-xs text-studio-faint">
                    © <?php echo e(date('Y')); ?> Chinhari Tattoo Studio. All rights reserved. Raipur, Chhattisgarh.
                </p>
                <div class="flex gap-6">
                    <a href="<?php echo e(route('privacy')); ?>" class="text-xs text-studio-faint hover:text-gold transition-colors">Privacy Policy</a>
                    <a href="<?php echo e(route('terms')); ?>" class="text-xs text-studio-faint hover:text-gold transition-colors">Terms of Service</a>
                    <a href="<?php echo e(route('sitemap')); ?>" class="text-xs text-studio-faint hover:text-gold transition-colors">Sitemap</a>
                </div>
            </div>
        </div>
    </footer>
    ...
    <a
        href="https://wa.me/<?php echo e(config('studio.whatsapp_number')); ?>?text=Hi! I'd like to know more about tattoo services."
        ...
        >
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('success')): ?>
                <div class="card border-green-500/30 p-4 flex items-start gap-3">
                    ...
                    <p class="text-sm text-studio-gray"><?php echo e(session('success')); ?></p>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('error')): ?>
                <div class="card border-crimson/30 p-4 flex items-start gap-3">
                    ...
                    <p class="text-sm text-studio-gray"><?php echo e(session('error')); ?></p>
                    <button @click="show = false" class="ml-auto text-studio-faint hover:text-studio-white flex-shrink-0" aria-label="Dismiss">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/></svg>
                    </button>
                </div>
