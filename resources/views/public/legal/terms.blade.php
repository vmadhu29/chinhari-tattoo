...
<section class="relative pt-32 pb-20 overflow-hidden bg-studio-darker" aria-label="Terms of Service Header">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <h1 class="font-display text-4xl md:text-6xl text-studio-white tracking-wider mb-4">
            TERMS OF <span class="text-gold-gradient">SERVICE</span>
        </h1>
...
<section class="py-20 bg-studio-black border-t border-studio-border" aria-label="Terms of Service Details">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="prose prose-invert max-w-none text-studio-muted text-sm leading-relaxed space-y-6">
            <h2 class="text-studio-white font-display text-2xl tracking-wide uppercase mt-8">1. Booking & Deposits</h2>
            <p>
                To reserve an appointment time, you must pay a booking deposit. This deposit is non-refundable but will be fully applied toward the final cost of your tattoo on the day of your session.
            </p>

            <h2 class="text-studio-white font-display text-2xl tracking-wide uppercase mt-8">2. Rescheduling Policy</h2>
            <p>
                You may reschedule your appointment with at least 24 hours notice, and your deposit will carry over to the new date. Cancellations made with less than 24 hours notice or failure to show up will result in forfeiture of the deposit.
            </p>
