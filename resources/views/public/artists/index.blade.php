...
<section class="relative pt-32 pb-20 overflow-hidden" aria-label="Artists Header">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <div class="flex items-center justify-center gap-4 mb-4">
            ...
            <span class="text-verli text-xs tracking-[0.4em] uppercase font-semibold">THE CREATIVE MINDS</span>
            <div class="w-8 h-px bg-verli/60"></div>
        </div>
        <h1 class="font-display text-5xl md:text-7xl text-studio-white tracking-wider mb-6">
            OUR <span class="text-verli-gradient">ARTIST</span>
        </h1>
...
<section class="py-20 bg-studio-darker border-t border-studio-border" aria-label="Artists Gallery">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-wrap justify-center gap-8">
            ...
            <div class="artist-card w-full max-w-sm flex flex-col h-full bg-studio-black border border-studio-border rounded-2xl overflow-hidden hover:border-verli/30 transition-all duration-300 shadow-card" data-reveal data-delay="{{ $i * 100 }}">
                ...
                <div class="p-6 flex flex-col flex-grow">
                    <div class="flex items-start justify-between mb-3">
                        <div>
                            ...
                            <p class="text-verli text-xs tracking-wider uppercase mt-1">{{ $artist->tagline }}</p>
                        </div>
                        <span class="badge-verli text-xs px-2.5 py-1">{{ $artist->experience_years }}+ Years</span>
                    </div>
                    ...
                    <div class="flex gap-3 mt-auto">
                        <a href="{{ route('artists.show', $artist->slug) }}" class="btn-outline-verli btn-sm w-1/2 text-center">View Portfolio</a>
                        <a href="{{ route('booking.create', ['artist' => $artist->id]) }}" class="btn-verli btn-sm w-1/2 text-center">Book Artist</a>
                    </div>
                </div>
            </div>
            @endforeach
