...
@php
$siteLogoPath = \App\Models\Setting::where('key', 'site_logo')->value('value');
$siteLogo = $siteLogoPath ? asset('storage/' . $siteLogoPath) : asset('images/logo.jpg');
@endphp
...
<body class="bg-white text-studio-gray min-h-screen overflow-x-hidden">
    ...
    {{-- Background ambient glow & Godna tribal pattern overlay --}}
    <div class="fixed inset-0 pointer-events-none overflow-hidden z-0" aria-hidden="true">
        <div class="absolute inset-0 godna-bg"></div>
        <div class="absolute top-0 left-1/4 w-96 h-96 bg-verli/5 rounded-full blur-3xl"></div>
        <div class="absolute bottom-0 right-1/4 w-80 h-80 bg-verli-light/5 rounded-full blur-3xl"></div>
    </div>

    {{-- Tribal Top Border --}}
    <div class="fixed top-0 left-0 right-0 h-1.5 z-[60] tribal-bg opacity-30 pointer-events-none"></div>
    ...
    <header
        ...
        "
        :class="scrolled ? 'py-3 shadow-verli-sm' : 'py-5'"
        role="navigation"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('home') }}" class="flex items-center gap-3 group" aria-label="Chinhari Tattoo Studio">
                    ...
                    <div>
                        <div class="font-display text-xl tracking-[0.15em] transition-colors duration-300 leading-none font-bold text-verli hover:text-verli-light">
                            CHINHARI
                        </div>
                        <div class="text-[9px] tracking-[0.35em] uppercase leading-none mt-1 text-studio-muted">
                            Tattoo Studio · Raipur
                        </div>
                    </div>
                </a>
                ...
                <nav class="hidden lg:flex items-center gap-1" aria-label="Primary">
                    ...
                    <a
                        ...
                        class="px-4 py-2 text-sm font-medium tracking-wide rounded-lg transition-all duration-200 link-underline
                                   {{ request()->routeIs($item['route']) ? 'text-verli' : 'text-studio-gray hover:text-verli' }}">
                        {{ $item['label'] }}
                    </a>
                    @endforeach
                </nav>
                ...
                <button
                    ...
                    <span class="w-6 h-0.5 group-hover:bg-verli transition-all duration-300 bg-studio-gray"
            ...
            <div
                ...
                <nav class="flex flex-col gap-1 mt-4" aria-label="Mobile">
                    ...
                    <a
                        ...
                        class="px-4 py-3 text-sm font-medium rounded-xl transition-colors duration-200
                                   {{ request()->routeIs($item['route']) ? 'text-verli bg-verli/5' : 'text-studio-gray hover:text-studio-white hover:bg-studio-charcoal' }}"
                ...
                <div class="flex flex-col gap-3 mt-6 px-4">
                    <a href="{{ route('booking.create') }}" class="btn-verli w-full text-center">Book Appointment</a>
    ...
    <footer class="bg-studio-darker border-t border-studio-border mt-0" role="contentinfo">
        ...
        <div class="bg-white py-16 px-4 text-center relative overflow-hidden">
            ...
            <div class="relative max-w-3xl mx-auto">
                ...
                <h2 class="font-display text-display-md md:text-display-lg text-studio-white mb-6 leading-none tracking-wider">
                    YOUR STORY<br>
                    <span class="text-verli-gradient">DESERVES INK</span>
                </h2>
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="{{ route('booking.create') }}" class="btn-verli btn-lg">
                        Book Free Consultation
                    </a>
                    <a href="https://wa.me/{{ config('studio.whatsapp_number') }}?text=Hi! I'd like to book a tattoo appointment." class="btn-outline-verli btn-lg" target="_blank" rel="noopener">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413Z" />
                        </svg>
                        Chat on WhatsApp
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                ...
                <div class="lg:col-span-1">
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            ...
                            <div class="text-[9px] tracking-[0.3em] text-verli uppercase leading-none mt-1">Tattoo Studio</div>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-3">
                        @php
                        $socials = [
                        ['href' => config('studio.instagram'), 'label' => 'Instagram', 'icon' => '
                        ...
                        ['href' => config('studio.facebook'), 'label' => 'Facebook', 'icon' => '
                        <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />'],
                        ['href' => config('studio.youtube'), 'label' => 'YouTube', 'icon' => '
                        <path d="M23.495 6.205a3.007 3.007 0 0 0-2.088-2.088c-1.87-.501-9.396-.501-9.396-.501s-7.507-.01-9.396.501A3.007 3.007 0 0 0 .527 6.205a31.247 31.247 0 0 0-.522 5.805 31.247 31.247 0 0 0 .522 5.783 3.007 3.007 0 0 0 2.088 2.088c1.868.502 9.396.502 9.396.502s7.506 0 9.396-.502a3.007 3.007 0 0 0 2.088-2.088 31.247 31.247 0 0 0 .5-5.783 31.247 31.247 0 0 0-.5-5.805zM9.609 15.601V8.408l6.264 3.602z" />'],
                        ['href' => 'https://wa.me/'.config('studio.whatsapp_number'), 'label' => 'WhatsApp', 'icon' => '
                        <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413Z" />'],
                        ];
                        @endphp
                    ...
                    <ul class="space-y-3">
                        ...
                        <li>
                            <a href="{{ route($link['route']) }}"
                                class="text-sm text-verli hover:text-verli-light transition-colors duration-200 link-underline">
                                {{ $link['label'] }}
                            </a>
                        </li>
                        @endforeach
                ...
                <div>
                    ...
                    <address class="not-italic space-y-4">
                        <div>
                            ...
                            <a href="{{ config('studio.google_maps_url') }}" class="text-xs text-verli hover:text-verli-light mt-1 inline-block" target="_blank" rel="noopener">Get Directions →</a>
                        </div>

                        <div>
                            <a href="tel:{{ config('studio.phone') }}" class="text-sm text-studio-muted hover:text-verli transition-colors">{{ config('studio.phone') }}</a>
                        </div>

                        <div class="text-sm text-studio-muted">
                            <p>Mon – Sunday</p>
                            <p class="text-studio-muted">10:00 AM – 10:00 PM</p>
                        </div>
                    </address>
                </div>
            </div>
            ...
            {{-- Floating Footer Art --}}
            <svg class="absolute bottom-32 right-4 w-32 h-32 opacity-20 pointer-events-none text-verli hidden md:block" viewBox="0 0 100 100" fill="none" stroke="currentColor" stroke-width="1.5">
                <path d="M70 90 L70 30" stroke-width="2" />
                <path d="M70 70 L55 55 M70 60 L85 45 M70 50 L55 35 M70 40 L85 25 M70 30 L60 20 M70 30 L80 20" />
                ...
                <g transform="translate(40, 65)">
                    ...
                    <polygon points="5,5 0,15 10,15" fill="currentColor" stroke="none" />
                    <path d="M0 10 L-5 5 M10 10 L15 5 M2 15 L0 25 M8 15 L10 25" />
                </g>
            </svg>
        </div>

        {{-- Footer Bottom --}}
        <div class="border-t border-studio-border py-6 relative">
            <div class="absolute top-0 left-0 right-0 h-1.5 tribal-bg opacity-35 pointer-events-none"></div>
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
                <div class="flex items-center gap-2">
                    <svg class="w-3 h-3 text-verli" viewBox="0 0 24 24" fill="currentColor">
                        <polygon points="12,2 22,12 12,22 2,12" />
                    </svg>
                    <p class="text-xs text-studio-faint">
                        © {{ date('Y') }} Chinhari Tattoo Studio. All rights reserved. Raipur, Chhattisgarh. <span class="mx-1">&bull;</span> Designed &amp; Developed by Madhu Verma
                    </p>
                </div>
                <div class="flex gap-4 sm:gap-6 items-center">
                    <a href="{{ route('privacy') }}" class="text-xs text-studio-faint hover:text-verli transition-colors">Privacy Policy</a>
                    <svg class="w-1.5 h-1.5 text-verli/50" viewBox="0 0 24 24" fill="currentColor">
                        <polygon points="12,2 22,12 12,22 2,12" />
                    </svg>
                    <a href="{{ route('terms') }}" class="text-xs text-studio-faint hover:text-verli transition-colors">Terms of Service</a>
                    <svg class="w-1.5 h-1.5 text-verli/50" viewBox="0 0 24 24" fill="currentColor">
                        <polygon points="12,2 22,12 12,22 2,12" />
                    </svg>
                    <a href="{{ route('sitemap') }}" class="text-xs text-studio-faint hover:text-verli transition-colors">Sitemap</a>
                </div>
            </div>
        </div>
    </footer>
    ...
    <button
        ...
        class="fixed bottom-24 right-6 z-40 w-10 h-10 rounded-full bg-studio-card border border-studio-border
               text-studio-muted hover:text-verli hover:border-verli/50
    ...
    <div
        ...
        <div class="card border-crimson/30 p-4 flex items-start gap-3">
            <div class="w-5 h-5 rounded-full bg-crimson/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                <svg class="w-3 h-3 text-crimson-light" fill="none" stroke="currentColor" viewBox="0 0 24 24">
